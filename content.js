...
window.NuevaSemilla = {
  ...
  people: {
    ...
    dario: {name:'Darío COLANERI', initials:'DC', photo:'assets/persona-dario.png', credit:'Fotografía: archivo de participantes de Nueva Semilla.', role:'Agroecología', establishment:'El Buen Vivir', location:'Alpa Corral'},
    ...
    guillermo: {name:'Guillermo SCHUSTER', initials:'GS', photo:'assets/persona-guillermo.png', credit:'Fotografía: archivo de participantes de Nueva Semilla.', role:'Producción bovina', establishment:'La Mandinga', location:'Almafuerte'},
    ...
    edgardo: {name:'Edgardo BALDELLI', initials:'EB', role:'Bioconstrucción'},
  ...
  advice: [
    ...
    {id:'bovino',name:'As. Bovino',title:'Ganadería en diálogo con el territorio.',description:'Experiencias de producción bovina compartidas por Laura MEINERO, de La Milagrosa, Coronel Moldes; Guillermo SCHUSTER, de La Mandinga; y Francisco FONTANETO, de Los Chanaritos.',people:['laura','guillermo','francisco'],topics:['Producción bovina','Pasturas','Sistemas integrados']},
    ...
    {id:'bioconstruccion',name:'As. Bioconstrucción',title:'Construir una forma de habitar.',description:'Un acercamiento a la bioconstrucción y a los saberes de Edgardo BALDELLI para pensar los espacios que habitamos.',people:['edgardo'],topics:['Bioconstrucción','Hábitat','Materiales']}
  ],
  proposals: [
    ...
    {id:'voluntariados',name:'Voluntariados',title:'Aprender haciendo. Compartir la vida rural.',description:'El voluntariado abre un encuentro entre personas, territorios y formas de producir. Elegí el establecimiento para conocer sus propuestas y canales de contacto.',projects:[{name:'La Pequelette',workaway:'https://www.workaway.info/en/host/219254886438'},{name:'El Alto Lindo'}]},
  ...
  participants: [
    {id:'el-buen-vivir',name:'El Buen Vivir',location:'Alpa Corral',description:'Establecimiento de la red en Alpa Corral, compartido por Viviana PEIRÓ y Darío COLANERI.',people:['viviana','dario']},
    ...
    {id:'la-mandinga',name:'La Mandinga',location:'Almafuerte',description:'Ivi MACAGNO y Guillermo SCHUSTER comparten sus experiencias de producción hortícola y bovina. La Mandinga también ofrece pollos pastoriles.',people:['ivanaMandinga','guillermo'],links:[['Pollos Pastoriles','#gastronomia/venta-directa/pollo-de-campo'],['Asesoramiento hortícola','#asesoramiento/horticola']]},
    ...
    {id:'paula-edgardo',name:'Paula MELEGATTI & Edgardo BALDELLI',location:null,activities:'Apicultura · Bioconstrucción',description:'Paula MELEGATTI comparte sus saberes apícolas y coordina el Programa de Apicultura de la UNRC. Edgardo BALDELLI participa del espacio de bioconstrucción.',people:['paula','edgardo'],links:[['Asesoramiento apícola','#asesoramiento/apicola'],['Bioconstrucción','#asesoramiento/bioconstruccion']]},
