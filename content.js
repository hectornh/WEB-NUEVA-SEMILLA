...
window.NuevaSemilla = {
  ...
  people: {
    ...
    dario: {name:'Darío Colaneri', initials:'DC', photo:'assets/persona-dario.png', credit:'Fotografía: archivo de participantes de Nueva Semilla.', role:'Agroecología · Alpa Corral'},
    sarmiento: {name:'Claudio Sarmiento', initials:'CS', role:'Agroecología · proyecto ALdeA'},
    ivanaMandinga: {name:'Ivana · La Mandinga', initials:'IM', photo:'assets/persona-ivana-mandinga.jpeg', credit:'Fotografía: archivo de participantes de Nueva Semilla.', role:'Horticultura · La Mandinga, Almafuerte'},
    laura: {name:'Laura Meinero', initials:'LM', photo:'assets/persona-laura-meinero.jpeg', credit:'Fotografía: archivo de participantes de Nueva Semilla.', role:'Producción bovina · La Milagrosa, Coronel Moldes'},
    guillermo: {name:'Guillermo · La Mandinga', initials:'GM', photo:'assets/persona-guillermo.png', credit:'Fotografía: archivo de participantes de Nueva Semilla.', role:'Producción bovina · Almafuerte'},
    francisco: {name:'Francisco · Los Chañaritos', initials:'FC', photo:'assets/persona-francisco.jpg', credit:'Fotografía: archivo de participantes de Nueva Semilla.', role:'Producción bovina · Villa María'},
    magali: {name:'Magali Guigon', initials:'MG', role:'Producción caprina'},
    ivanaAcequias: {name:'Ivana · 3 Acequias', initials:'IA', role:'Avicultura · pollitos'},
    ...
    viviana: {name:'Viviana Peiró', initials:'VP', photo:'assets/persona-viviana.png', credit:'Fotografía: archivo de participantes de Nueva Semilla.', role:'El Buen Vivir · Alpa Corral'},
  ...
  advice: [
    ...
    {id:'bovino',name:'As. Bovino',title:'Ganadería en diálogo con el territorio.',description:'Experiencias de producción bovina compartidas por Guillermo, de La Mandinga; Francisco, de Los Chañaritos; y Laura Meinero, de La Milagrosa, Coronel Moldes.',people:['guillermo','francisco','laura'],topics:['Producción bovina','Pasturas','Sistemas integrados']},
  ...
  experiences: [
    ...
    {id:'merienda-a-campo',name:'El Alto Lindo',title:'Merienda a campo',location:'El Alto Lindo',participant:'el-alto-lindo',description:'Una invitación a compartir la mesa y conocer la vida a campo en El Alto Lindo.'}
  ],
  about: [
  ...
  participants: [
    ...
    {id:'la-mandinga',name:'La Mandinga',location:'Almafuerte',description:'Ivana y Guillermo comparten sus experiencias de producción hortícola y bovina. La Mandinga también ofrece pollo de campo.',people:['ivanaMandinga','guillermo'],links:[['Pollo de campo','#gastronomia/venta-directa/pollo-de-campo'],['Asesoramiento hortícola','#asesoramiento/horticola']]},
