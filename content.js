...
window.NuevaSemilla = {
  ...
  people: {
    ...
    ivanaMandinga: {name:'Ivana · La Mandinga', initials:'IM', role:'Horticultura · Almafuerte'},
    ...
    micaela: {name:'Micaela Bedano', initials:'MB', role:'Apicultura'},
  ...
  advice: [
    ...
    {id:'bovino',name:'As. Bovino',title:'Ganadería en diálogo con el territorio.',description:'Experiencias de producción bovina compartidas por Guillermo, de La Mandinga, y Francisco, de Los Chañaritos.',people:['guillermo','francisco'],topics:['Producción bovina','Pasturas','Sistemas integrados']},
