...
const names = {'asesoramiento':'Asesoramiento Profesional','propuestas':'Propuestas Pedagógicas','gastronomia':'Propuestas de Compra','mapa':'Mapa','quienes-somos':'Quiénes Somos'};
const intros = {
...
function home(){
 ...
 ['gastronomia','Propuestas de Compra','Alimentos, fitomedicina y encuentros con origen.'],
...
function gastronomy(id,detail){
 ...
 return intro('gastronomia')+`<div class="wrap page-body">${subnav(D.gastronomy,'gastronomia',active,'subnav','Secciones de Propuestas de Compra')}${body}</div>`;
}
function map(){
