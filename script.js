...
const names = {'asesoramiento':'Asesoramiento','propuestas':'Propuestas','gastronomia':'Gastronomía & Fitomedicina','mapa':'Mapa','quienes-somos':'Quiénes Somos'};
const intros = {
...
function home(){
 ...
 ['gastronomia','Gastronomía & Fitomedicina','Alimentos, fitomedicina y encuentros con origen.'],
...
function gastronomy(id,detail){
 ...
 return intro('gastronomia')+`<div class="wrap page-body">${subnav(D.gastronomy,'gastronomia',active,'subnav','Secciones de Gastronomía y Fitomedicina')}${body}</div>`;
}
function map(){
